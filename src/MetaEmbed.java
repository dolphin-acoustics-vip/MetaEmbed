...
public class MetaEmbed {
    public static void main(String[] args) {
        EmbedOneDrive("test_data.csv",
                "https://universityofstandrews907-my.sharepoint.com/personal/ht51_st-andrews_ac_uk/_layouts/15/onedrive.aspx?id=%2Fsites%2FDolphinAcousticsVIP2%2FShared%20Documents%2FGeneral%2FConcept%20Folder%2FSpecies%20%28Master%20Folder%29%2FBrazil%2FSteno%2FPICEAS2005%2FA23&listurl=https%3A%2F%2Funiversityofstandrews907%2Esharepoint%2Ecom%2Fsites%2FDolphinAcousticsVIP2%2FShared%20Documents&viewid=bc200e1a%2D1826%2D49f8%2Dab05%2D406e393a1e96");
    }
    ...
    public static void EmbedOneDrive(String localPath, String OneDriveURL) {
        ...
        OneDrivePath folder = new OneDrivePath();

        ArrayList<String> directory = folder.readURL(OneDriveURL);
    ...
    public static void EmbedLocal() {
        Append file = new Append();
        LocalPath folder = new LocalPath();

        String path = "/Users/haroldthain/Brazil/Steno/PMC/PMC_12_A23/sel01_test.csv";
        ArrayList<String> directory = folder.findPath(path);
